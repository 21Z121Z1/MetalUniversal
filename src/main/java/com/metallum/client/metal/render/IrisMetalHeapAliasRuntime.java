...
/**
 * Generation-scoped execution authority for an Iris placement-heap recipe.
 *
 ...
 * Once the live allocation set has been compiled, the stable recipe is kept
 * here and can be consumed by a later resize/reallocation in the same chain
 * generation. A new post-chain generation clears the authority before it can
 * cross into a different semantic graph.</p>
 */
