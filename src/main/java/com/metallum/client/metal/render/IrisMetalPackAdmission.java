...
final class IrisMetalPackAdmission {
    ...
    static void requireSupported(final ProgramSet programSet, final ColorSpace outputColorSpace) {
        ...
        requireColorSpaceSupported(outputColorSpace);
    ...
    private static void requireColorSpaceSupported(final ColorSpace colorSpace) {
        // ColorSpace is a fixed Iris enum. The actual pack-owned correction
        // bypass is selected at the final-stage executor once it is connected.
