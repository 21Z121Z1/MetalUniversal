...
/**
 * Fixed-Iris core draw resolver.
 *
 * <p>This is a catalog and resolver only. It does not own compilation or
 * execution state; the active generation remains responsible for those
 * operations. Keeping this boundary small prevents the old reference
 * pipeline-overrides runtime from becoming a second renderer.</p>
 */
...
public final class IrisMetalCoreGbufferPipelines {
    ...
    /** Reads the same live state that fixed Iris uses at draw resolution time. */
