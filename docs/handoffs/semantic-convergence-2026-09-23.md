...
| `chatgpt/replay-iris-correctness-20260830` | `566c69f56189a8b4e80dc773de4fe37fcd0effc8` | One 26.2 advanced-optimization correctness commit plus replay-parser/one-shot CI history. Current grouping is scope-owned with exception cleanup and allocation-aware hazards; shadow draw buffers and raw storage views are corrected here. No remaining 26.3 correctness blocker was found in the focused comparison. Preserve the exact tip; real-world shader-pack parity is unverified. |
